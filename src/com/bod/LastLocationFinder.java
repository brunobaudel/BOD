...
public class LastLocationFinder {
	protected static String TAG = "PreGingerbreadLastLocationFinder";
	  ...
	  protected GsmCellLocation location;
	  protected int cellID, lac;
	  /**
	  ...
	  public Location getLastBestLocation(int minDistance, long minTime) {
		...
		if(bestResult == null){
		    ...
		    if(location != null){
			    ...
			    lac = location.getLac();
			    if(lac > 0){
			 	    bestResult = new Location("TelephoneManager");
			 	    ConvertToLatLong bt = new ConvertToLatLong(cellID,lac);
			     	double[] latLong = bt.getLatLong();
			     	bestResult.setLatitude(latLong[0]);
			     	bestResult.setLongitude(latLong[1]);
			    }
		    }
		}
	    ...
	    if (locationListener != null && (bestTime > minTime || bestAccuracy > minDistance)) { 
	      String provider = locationManager.getBestProvider(criteria, true) == null ? locationManager.getBestProvider(criteria, false):
	   ...
	   * {@inheritDoc}
	   */
	  public void cancel(LocationListener locList) {
