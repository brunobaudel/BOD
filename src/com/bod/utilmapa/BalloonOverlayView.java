...
public class BalloonOverlayView<Item extends OverlayItemOpenDocs> extends FrameLayout {
	...
	public BalloonOverlayView(Context context, int balloonBottomOffset) {
		...
		inflater.inflate(R.layout.balloon_overlay, layout);
